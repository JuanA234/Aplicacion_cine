...
class ComidaCineRuta {
    constructor() {
        ...
        this.apiRutaComidaCine.put("/updateMassive", ComidaCineControlador_1.default.actualizaTuComidaMasivoCine);
        this.apiRutaComidaCine.delete("/deleteMassive", ComidaCineControlador_1.default.massiveDelete);
    }
}
