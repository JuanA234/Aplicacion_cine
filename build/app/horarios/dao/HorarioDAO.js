...
class HorarioDAO {
    static obtenerTodo(params, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default.result(sql_horario_1.SQL_HORARIOS.GET_ALL).then((resultado) => {
    ...
    static grabeloYa(datos, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (cubi.existe == 0) {
                    queHacer = 2;
                    respuBase = yield consulta.one(sql_horario_1.SQL_HORARIOS.ADD, [datos.idHorario, datos.fecha, datos.hora, datos.idPelicula]);
                }
    ...
    static actualiceloYa(datos, res) {
        return __awaiter(this, void 0, void 0, function* () {
            dbConnection_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (cubi.existe == 0) {
                    queHacer = 2;
                    respuBase = yield consulta.none(sql_horario_1.SQL_HORARIOS.UPDATE, [datos.fecha, datos.hora, datos.idPelicula]);
                }
                return { queHacer, respuBase };
            })).then(({ queHacer, respuBase }) => {
                switch (queHacer) {
