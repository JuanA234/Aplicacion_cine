...
class PersonasRuta {
    constructor() {
        ...
        this.apiRutaPersonas.get("/getPage", PersonasControlador_1.default.personasPaginadas);
        this.apiRutaPersonas.post("/create", PersonasControlador_1.default.obtenerPersona);
