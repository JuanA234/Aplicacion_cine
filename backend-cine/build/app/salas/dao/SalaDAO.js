...
class SalaDAO {
    static obtenerTodo(params, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default.result(sql_sala_1.SQL_SALAS.GET_ALL).then((resultado) => {
    ...
    static grabeloYa(datos, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (cubi.existe == 0) {
                    queHacer = 2;
                    respuBase = yield consulta.one(sql_sala_1.SQL_SALAS.ADD, [datos.idSala, datos.salaCapacidad, datos.idCine]);
                }
