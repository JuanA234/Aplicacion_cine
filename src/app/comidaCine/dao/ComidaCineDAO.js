...
var sql_comidaCine_1 = require("../repository/sql_comidaCine");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var ComidaCineDAO = /** @class */ (function () {
    function ComidaCineDAO() {
    }
    ComidaCineDAO.obtenerTodo = function (params, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.result(sql_comidaCine_1.SQL_COMIDA_CINE.GET_ALL).then(function (resultado) {
    ...
    ;
    ComidaCineDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.task(function (consulta) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_comidaCine_1.SQL_COMIDA_CINE.HOW_MANY, [datos.idMenu])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_comidaCine_1.SQL_COMIDA_CINE.ADD, [datos.precio, datos.cantidadDisponible, datos.idComida, datos.idCine])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
    ...
    ;
    ComidaCineDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ;
    ComidaCineDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(cubi.existe != 0)) return [3 /*break*/, 3];
                                queHacer = 2;
                                return [4 /*yield*/, consulta.none(sql_comidaCine_1.SQL_COMIDA_CINE.UPDATE, [datos.precio, datos.cantidadDisponible, datos.idComida, datos.idCine])];
                            case 2:
                                respuBase = _a.sent();
                                _a.label = 3;
                            case 3: return [2 /*return*/, { queHacer: queHacer, respuBase: respuBase }];
