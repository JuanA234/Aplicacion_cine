...
var sql_sala_1 = require("../repository/sql_sala");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var SalaDAO = /** @class */ (function () {
    function SalaDAO() {
    }
    SalaDAO.obtenerTodo = function (params, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.result(sql_sala_1.SQL_SALAS.GET_ALL).then(function (resultado) {
    ...
    ;
    SalaDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.task(function (consulta) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_sala_1.SQL_SALAS.HOW_MANY, [datos.idSala])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_sala_1.SQL_SALAS.ADD, [datos.idSala, datos.salaCapacidad, datos.idCine])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
    ...
    ;
    SalaDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ;
    SalaDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(cubi.existe != 0)) return [3 /*break*/, 3];
                                queHacer = 2;
                                return [4 /*yield*/, consulta.none(sql_sala_1.SQL_SALAS.UPDATE, [datos.salaCapacidad, datos.idCine, datos.idSala])];
                            case 2:
                                respuBase = _a.sent();
                                _a.label = 3;
                            case 3: return [2 /*return*/, { queHacer: queHacer, respuBase: respuBase }];
