...
var sql_cine_1 = require("../repository/sql_cine");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var CineDAO = /** @class */ (function () {
    function CineDAO() {
    }
    CineDAO.obtenerTodo = function (params, res) {
    ...
    CineDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_cine_1.SQL_CINES.HOW_MANY, [datos.idCine])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_cine_1.SQL_CINES.ADD, [datos.nombreCine, datos.idUbicacion])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
    ...
    CineDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    CineDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.none(sql_cine_1.SQL_CINES.UPDATE, [datos.idUbicacion, datos.idUbicacion, datos.idCine])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
                                    case 3: return [2 /*return*/, { queHacer: queHacer, respuBase: respuBase }];
