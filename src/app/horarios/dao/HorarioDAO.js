...
var sql_horario_1 = require("../repository/sql_horario");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var HorarioDAO = /** @class */ (function () {
    function HorarioDAO() {
    }
    HorarioDAO.obtenerTodo = function (params, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.result(sql_horario_1.SQL_HORARIOS.GET_ALL).then(function (resultado) {
    ...
    ;
    HorarioDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.task(function (consulta) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_horario_1.SQL_HORARIOS.HOW_MANY, [datos.idHorario])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_horario_1.SQL_HORARIOS.ADD, [datos.fecha, datos.hora, datos.idPelicula])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
    ...
    ;
    HorarioDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ;
    HorarioDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(cubi.existe != 0)) return [3 /*break*/, 3];
                                queHacer = 2;
                                return [4 /*yield*/, consulta.none(sql_horario_1.SQL_HORARIOS.UPDATE, [datos.fecha, datos.hora, datos.idPelicula])];
                            case 2:
                                respuBase = _a.sent();
                                _a.label = 3;
                            case 3: return [2 /*return*/, { queHacer: queHacer, respuBase: respuBase }];
