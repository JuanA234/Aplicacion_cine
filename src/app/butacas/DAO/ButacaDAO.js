...
var sql_butacas_1 = require("../repository/sql_butacas");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var ButacaDAO = /** @class */ (function () {
    function ButacaDAO() {
    }
    ButacaDAO.obtenerTodo = function (params, res) {
    ...
    ButacaDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default
                            .task(function (consulta) { return __awaiter(_this, void 0, void 0, function () {
                            var queHacer, respuBase, cubi;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_butacas_1.SQL_BUTACAS.HOW_MANY, [datos.idButaca])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_butacas_1.SQL_BUTACAS.ADD, [datos.fila, datos.columna, datos.idSala])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
    ...
    ButacaDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                dbConnection_1.default
                    .task(function (consulta) {
    ...
    ButacaDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!(cubi.existe != 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.none(sql_butacas_1.SQL_BUTACAS.UPDATE, [datos.fila, datos.columna, datos.idSala, datos.idButaca])];
                                    case 2:
                                        respuBase = _a.sent();
                                        _a.label = 3;
                                    case 3: return [2 /*return*/, { queHacer: queHacer, respuBase: respuBase }];
