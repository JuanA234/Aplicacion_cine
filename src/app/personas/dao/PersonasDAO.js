...
var sql_personas_1 = require("../repository/sql_personas");
var dbConnection_1 = require("../../../config/connection/dbConnection");
var PersonasDAO = /** @class */ (function () {
    function PersonasDAO() {
    }
    PersonasDAO.obtenerTodo = function (params, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.result(sql_personas_1.SQL_PERSONAS.GET_ALL).then(function (resultado) {
    ...
    ;
    PersonasDAO.grabeloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbConnection_1.default.task(function (consulta) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        queHacer = 1;
                                        return [4 /*yield*/, consulta.one(sql_personas_1.SQL_PERSONAS.HOW_MANY, [datos.idPersona])];
                                    case 1:
                                        cubi = _a.sent();
                                        if (!(cubi.existe == 0)) return [3 /*break*/, 3];
                                        queHacer = 2;
                                        return [4 /*yield*/, consulta.one(sql_personas_1.SQL_PERSONAS.ADD, [datos.nombrePersona, datos.fechaNacimientoPersona,
    ...
    ;
    PersonasDAO.borreloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ;
    PersonasDAO.actualiceloYa = function (datos, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(cubi.existe != 0)) return [3 /*break*/, 3];
                                queHacer = 2;
                                return [4 /*yield*/, consulta.none(sql_personas_1.SQL_PERSONAS.UPDATE, [datos.nombrePersona, datos.fechaNacimientoPersona,
